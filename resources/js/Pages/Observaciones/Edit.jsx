...
const Edit = ({ observacion, especies, tiempos, lugares }) => {
  const { data, setData, put, errors } = useForm({
    id_especie: observacion.id_especie,
    inicio_deteccion: observacion.inicio_deteccion,
    fin_deteccion: observacion.fin_deteccion,
    duracion_deteccion: observacion.duracion_deteccion,
    id_lugar: observacion.id_lugar,
  });

  const handleSubmit = (e) => {
    e.preventDefault();
    put(`/observacion/${observacion.id_observacion}`);
  };
